...
namespace Client.EmployeeService {
    ...
    public partial class EmployeeInfo {
        ...
        public Client.EmployeeService.EmployeeType EmployeeType;
        ...
        public EmployeeInfo(int Id, string Name, string Gender, System.DateTime DOB, Client.EmployeeService.EmployeeType EmployeeType, int AnnualSalary, int HourlyPay, int HoursWorked) {
            this.Id = Id;
            this.Name = Name;
            this.Gender = Gender;
            this.DOB = DOB;
    ...
    public partial class EmployeeServiceClient : System.ServiceModel.ClientBase<Client.EmployeeService.IEmployeeService>, Client.EmployeeService.IEmployeeService {
        ...
        public int GetEmployee(string LicenseKey, int EmployeeId, out string Name, out string Gender, out System.DateTime DOB, out Client.EmployeeService.EmployeeType EmployeeType, out int AnnualSalary, out int HourlyPay, out int HoursWorked) {
        ...
        public void SaveEmployee(int Id, string Name, string Gender, System.DateTime DOB, Client.EmployeeService.EmployeeType EmployeeType, int AnnualSalary, int HourlyPay, int HoursWorked) {
        ...
        public System.Threading.Tasks.Task<Client.EmployeeService.SaveEmployeeResponse> SaveEmployeeAsync(int Id, string Name, string Gender, System.DateTime DOB, Client.EmployeeService.EmployeeType EmployeeType, int AnnualSalary, int HourlyPay, int HoursWorked) {
            Client.EmployeeService.EmployeeInfo inValue = new Client.EmployeeService.EmployeeInfo();
            inValue.Id = Id;
            inValue.Name = Name;
            inValue.Gender = Gender;
